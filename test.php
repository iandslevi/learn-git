...
<head>
	...
	})(window,document,'script','dataLayer','GTM-WR3S4V4');</script>
	 End Google Tag Manager -->
</head>
<body ng-controller="MainCtrl">
	
	<!-- Google Tag Manager (noscript) new
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WR3S4V4"
